...
function GENAIandMLmore() {
    ...
    const selectedMenuItem = filterAndExtractDescriptions(menuItems, 'GENAIandMLmore');
            ...
            <div className='relative w-full h-[300px] sm:h-[400px] md:h-[515px] overflow-hidden'>
                ...
                <div className='absolute inset-0 flex items-center justify-center'>
                    <div className='text-center'>
                        <h1 className='text-white font-roboto text-[40px] sm:text-[40px] md:text-[74px] font-semibold leading-tight sm:leading-snug md:leading-tight tracking-[-0.48px] mb-2 sm:mb-4 md:mb-6 pt-[90px]'>
                            GEN AI and ML
                        </h1>
                        <img
                            src={bluemark}
