...
import bg from '../../../../../assets/backgroundimgs/Mobility/intracitybuyer.jpeg'
function IntracityBuyer() {
    const heroData = {
        title: "Intra City Buyer",
