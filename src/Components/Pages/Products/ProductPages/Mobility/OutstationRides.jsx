...
import bg from '../../../../../assets/backgroundimgs/Mobility/outstationride.jpeg'
function OutstationRides() {
    const heroData = {
        title: "Out Station Ride",
    ...
    const contentSections = [
        {
            title: "About Out Station Rides Solutions",
