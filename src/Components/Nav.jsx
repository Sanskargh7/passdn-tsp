...
export default function Nav() {
    ...
    return (
        <>
            <div className={header ? "fixed z-50 text-black w-[100%] bg-[white]  border-b-[1px] border-[#828282]" : "fixed bg-black w-[100%] text-white border-b-[2px] border-[#828282] z-50 "}>

                <div className="h-4vh px-8 flex justify-between sm:justify-between z-auto sm:px-[3%] h-[40px] py-[48px] items-center w-full ">
                    <div className={header ? 'text-black' : " text-white    "}>
                    ...
                    <div class={header ? "bg-black text-white md:w-[180px] h-12 px-6  justify-center items-center sm:inline-flex hidden" : "md:w-[180px] h-12 px-6 bg-blue-600 justify-center items-center sm:inline-flex text-white hidden"}>
